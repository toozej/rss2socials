...
//
// This package creates Unix manual pages (man pages) for the rss2socials CLI
...
// Example usage:
//
//	import "github.com/toozej/rss2socials/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./rss2socials man > rss2socials.1
package man
...
// for the rss2socials application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates rss2socials's command line manpages",
		SilenceUsage:          true,
